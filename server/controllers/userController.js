...
const getEnrichedUserData = async (query) => {
  ...
  return {
    ...
    totalDurationInvested: summary.balances.totalDurationInvested,
    totalGeneralInvested: summary.balances.totalDurationInvested,
    activeDurationInvestmentsCount: summary.balances.activeDurationInvestmentsCount,
    durationDailyInterest: summary.balances.durationDailyInterest,
    durationAccruedInterest: summary.balances.durationAccruedInterest,
